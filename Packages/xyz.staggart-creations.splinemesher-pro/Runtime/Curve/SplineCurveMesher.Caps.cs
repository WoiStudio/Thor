...
namespace sc.splinemesher.pro.runtime
{
    public partial class SplineCurveMesher
    {
        ...
        public class Cap
        {
            ...
            public bool RequiresRespawn(int splineCount)
            {
                return HasNoInstances() || HasPrefabChanged() || HasMissingInstances() || InstanceCount != splineCount;
            }
        ...
        public void UpdateCaps(NativeSpline spline, int splineIndex, SplineCurveMeshData splineMeshData, CurveMeshSettings settings)
        {
            ...
            if (settings.caps.startCap.RequiresRespawn(splineCount))
            {
            ...
            if (settings.caps.endCap.RequiresRespawn(splineCount))
            {
