...
namespace sc.splinemesher.pro.editor
{
    ...
    {
        #region Help section
        [MenuItem("Window/"+ AssetInfo.ASSET_NAME + "/Hub Window", false, 1000)]
        private static void OpenHelpWindow()
        {
            HelpWindow.ShowWindow();
        }
        
        [MenuItem("Window/"+ AssetInfo.ASSET_NAME + "/Open Demo Scene", false, 1001)]
        private static void OpenDemoScene()
        {
            string path = AssetDatabase.GUIDToAssetPath("d98e0574e820345449e02a1948977576");
            
            EditorSceneManager.OpenScene(path);
        }
        
        [MenuItem("Window/"+ AssetInfo.ASSET_NAME + "/Open Project Settings", false, 2000)]
        private static void OpenProjectSettings()
        {
            SplineMesherSettings.OpenProjectSettings();
        }
        
        [MenuItem("Window/"+ AssetInfo.ASSET_NAME + "/Open Preferences", false, 2001)]
